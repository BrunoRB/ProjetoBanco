...
INSERT INTO tipo (tipo) VALUES ('administrador'), ('gerente'), ('membro'), ('cliente');

INSERT INTO usuario VALUES (1, 'adm', 'adm', 'adm', (SELECT id_tipo FROM tipo WHERE tipo = 'administrador'));

INSERT INTO administrador VALUES (1, 1);

INSERT INTO usuario VALUES (2, 'gerente', 'gerente', 'adm', (SELECT id_tipo FROM tipo WHERE tipo = 'gerente'));
...
INSERT INTO membro VALUES (1, '05-05-2012', 'gerente de desenvolvimento', 3);
...
INSERT INTO despesa VALUES (1, 'salario', 10.000, 'Descrição da despesa', 1, 1);

--incoerência entre despesa x recurso x membro a ser resolvida (depesa pode ser tanto de recurso quanto de membro);

INSERT INTO recurso VALUES (1, 'pc', 'computador de mesa', 1, 1);
